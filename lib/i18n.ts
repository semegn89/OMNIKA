...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      imageLoadError: 'Image not available',
      retry: 'Retry',
      unsplashDemo: 'Automatically load high-quality images from Unsplash',
      productImages: 'Product Category Images',
      ...
      downloadCommand: 'Run this command to download images to your local directory:',
      useComponent: 'Use ImageLoader Component',
      componentUsage: 'Use the ImageLoader component in your pages:',
      apiUsage: 'Use API Directly',
      apiCall: 'Make API calls to get image URLs:'
    },
    orderConfirmation: {
  ...
  ro: {
    ...
    checkout: {
      ...
      imageLoadError: 'Imaginea nu este disponibilă',
      retry: 'Reîncearcă',
      unsplashDemo: 'Încarcă automat imagini de înaltă calitate de pe Unsplash',
      productImages: 'Imagini Categorii Produse',
      brandImages: 'Imagini Mărci',
      sectionImages: 'Imagini Secțiuni',
      selectCategory: 'Selectează Categoria',
      selectBrand: 'Selectează Marca',
      selectSection: 'Selectează Secțiunea',
      instructions: 'Cum să Folosești',
      downloadImages: 'Descarcă Imagini',
      downloadCommand: 'Rulează această comandă pentru a descărca imaginile în directorul local:',
      useComponent: 'Folosește Componenta ImageLoader',
      componentUsage: 'Folosește componenta ImageLoader în paginile tale:',
      apiUsage: 'Folosește API-ul Direct',
      apiCall: 'Fă apeluri API pentru a obține URL-urile imaginilor:'
    },
    orderConfirmation: {
