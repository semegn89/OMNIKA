            ...
            <div className="space-y-8 text-gray-300 leading-relaxed">
              <section id="company">
                ...
                <div className="bg-dark-700 p-4 rounded-lg mb-4">
                  ...
                  <p><strong>Email:</strong> support@omnikaparts.com</p>
              ...
              <section id="privacy">
                ...
                <div className="space-y-4">
                  ...
                  <p><strong>Data Protection Officer:</strong> For privacy inquiries, contact us at privacy@omnikaparts.com</p>
              ...
              <section id="contact">
                ...
                <div className="bg-dark-700 p-4 rounded-lg">
                          <p><strong>For General Inquiries:</strong> support@omnikaparts.com</p>
        <p><strong>For Privacy Matters:</strong> privacy@omnikaparts.com</p>
                  <p><strong>Phone:</strong> +40 (31) 630-12-34</p>
